...
docker exec agroorbit-db-rm563901 psql -U postgres -d agroorbit -c "SELECT COUNT(*) AS total_users FROM tb_user;"
docker exec agroorbit-db-rm563901 psql -U postgres -d agroorbit -c "SELECT COUNT(*) AS total_farms FROM tb_farm;"
docker exec agroorbit-db-rm563901 psql -U postgres -d agroorbit -c "SELECT COUNT(*) AS total_crop_areas FROM tb_crop_area;"
